...
public class DbConnection {
    ...
    static {
        ...
        System.out.println("Acceso DB"); 
        
        //dataSource.setUrl("jdbc:mysql://localhost:3306/notifake?useUnicode=true&useJDBCCompliantTimeZoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
        dataSource.setUrl("jdbc:mysql://localhost:3306/notifakedb?useUnicode=true&useJDBCCompliantTimeZoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
        
        // El nombre de usuario de su conexion
        dataSource.setUsername("root");
        // La contraseña del usuario de su conexion
        // -------------------- principal
        dataSource.setPassword("Alarahi");
