            ...
            <div class="container">
                <form action="NoticiaController" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="Descripcion" id="Descripcion" placeholder="¡No te lo vas a creer! Los cientificos hablam sobre ello, algo que muchos ignoran y pocos se lo creen" rows="2"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="Genero" id="Genero">
                            ...
                            <option value = "3">Pelicula</option>
                        </select>
                    </div>
