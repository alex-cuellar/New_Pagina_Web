<%-- 
    ...
    Created on : 11/12/2020, 05:27:27 AM
    Author     : Sara
--%>
...
<body>
    ...
    <div class="container">
        ...
        <h2 class="genero">Mis noticias</h2>
       ...
       <div class="noticias">
                ...
                <div class="datosInf">
                    ...
                    <% int acep =  noticia.getAceptada();
                    String Aceptado;
                    if(acep == 0) Aceptado = "No aceptado";
                    else Aceptado = "Aceptado";
                    %>
                    <p class="datos"> Aceptado: <%= Aceptado %></p>
                </div>
