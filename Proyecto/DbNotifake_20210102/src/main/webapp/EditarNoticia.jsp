...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="container">
                <form action="EditarNoticiaController" method="POST" enctype="multipart/form-data">
                    <h1 class="H1">EDITAR NOTICIA</h1>

                    <div class="form-group">
                        <label for="Titu" class="Subtitulos">Titulo de la noticia EDITAR</label>
                        <input type="text" class="form-control" name="Titulo" placeholder="Los saltamontes no saltan montes" value = "<%= noticia.getTitulo()%>">
                    </div>

                    <div class="form-group">
                        <label for="descripcion1" class="Subtitulos">Descripcion Corta</label>
                        <input type="text" class="form-control" name="descripcion2" placeholder="Esta noticia te sorprendera" value = "<%= noticia.getDescripCorta()%>">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="Informacion1" id="Informacion1" rows="10"><%= noticia.getParrafo1()%></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="Informacion2" id="Informacion2" rows="10"><%= noticia.getParrafo2()%></textarea>
                    </div>
