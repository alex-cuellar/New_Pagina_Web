...
public class NoticiaController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String name1 = file1.getSubmittedFileName();
         String nameImage1fin;
        if (name1 != "") {
        ...
        file1.write(fullPath1);
         nameImage1fin = FileUtils.RUTE_USER_IMAGE + "/" + nameImage1;
        } else {
            nameImage1fin = "null";
        }

        Part file2 = request.getPart("SImage");
        String name2 = file2.getSubmittedFileName();
        String nameImage2fin;
        if (name2 != "") {
            ...
            nameImage2fin = FileUtils.RUTE_USER_IMAGE + "/" + nameImage2;
        } else {
            nameImage2fin = "null";
        }

        Part file3 = request.getPart("TImage");
        String name3 = file3.getSubmittedFileName();
        String nameImage3fin;
        if (name3 != "") {
        ...
        nameImage3fin = FileUtils.RUTE_USER_IMAGE + "/" + nameImage3;
        } else {
            nameImage3fin = "null";
        }

        int id = (int) request.getSession().getAttribute("id");
        Noticia noticia = new Noticia(Titulo, Descripcion, genero, Informacion1, Informacion2, nameImage1fin, nameImage2fin, nameImage3fin, "10-12-2020", id, "0");
