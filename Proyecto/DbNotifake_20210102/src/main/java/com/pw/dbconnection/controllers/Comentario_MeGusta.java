 ...
 * @author Sara
 */
@WebServlet(name = "Comentario_MeGusta", urlPatterns = {"/Comentario_MeGusta"})
public class Comentario_MeGusta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            FavoritosDAO.ComentarioMarcarMG(idc);
