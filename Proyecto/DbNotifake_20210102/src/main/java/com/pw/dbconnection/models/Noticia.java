...
public class Noticia {
    ...
    public Noticia(String Titulo, String DescripCorta, int idCategoria, String Parrafo1, String Parrafo2, String Imagen1, String Imagen2, String Imagen3, String fecha, int idUsuario, String Calif1) {
        this.Titulo = Titulo;
        this.DescripCorta = DescripCorta;
        this.idCategoria = idCategoria;
        this.Parrafo1 = Parrafo1;
  ...
  public Noticia(int id, String Titulo, String DescripCorta, int idCategoria, String Parrafo1, String Parrafo2, String Imagen1, String Imagen2, String Imagen3, String fecha, int idUsuario, String Autor, int Aceptada, String Calif1) {
        this.id = id;
        this.Titulo = Titulo;
        this.DescripCorta = DescripCorta;
        this.idCategoria = idCategoria;
    ...
    public Noticia(int id, String Titulo, String DescripCorta, String Imagen1) {
        this.id = id;
        this.Titulo = Titulo;
        this.DescripCorta = DescripCorta;
        this.Imagen1 = Imagen1;
