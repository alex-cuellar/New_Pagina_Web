 ...
 * @author Sara
 */
@WebServlet(name = "VerNoticiaUnsafeController", urlPatterns = {"/VerNoticiaUnsafeController"})
public class VerNoticiaUnsafeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            List<Comentarios> respuestas = ComentariosDAO.respuestasNoticia(Integer.parseInt(idn, 10));
