 ...
 * @author Sara
 */
@WebServlet(name = "EditarNoticiaController", urlPatterns = {"/EditarNoticiaController"})
...
public class EditarNoticiaController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Noticia noticia = NoticiaDAO.getNoticia(Integer.parseInt(idn, 10));
        noticia.getTitulo();
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Noticia noticia = new Noticia(Titulo, Descripcion, genero, Informacion1, Informacion2, FileUtils.RUTE_USER_IMAGE + "/" + nameImage1, FileUtils.RUTE_USER_IMAGE + "/" + nameImage2, FileUtils.RUTE_USER_IMAGE + "/" + nameImage3, "10-12-2020", id, "0");
        
        NoticiaDAO.NoticiaEdit(Titulo, Descripcion, genero, Informacion1, Informacion2, FileUtils.RUTE_USER_IMAGE + "/" + nameImage1, FileUtils.RUTE_USER_IMAGE + "/" + nameImage2, FileUtils.RUTE_USER_IMAGE + "/" + nameImage3, "10-12-2020", id, idn2);
